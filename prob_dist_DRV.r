...
prob_between_170_180 <- pnorm(180, mean=mean_height, sd=sd_height) - pnorm(170, mean=mean_height, sd=sd_height) print(paste("P(170 < height < 180) =", round(prob_between_170_180, 4)))
...
sample_heights <- rnorm(1000, mean=mean_height, sd=sd_height)
 hist(sample_heights, breaks=30, probability=TRUE, main="Histogram of Sampled Heights",
